...
//           <a href="/profile/me" className=" border-2 border-amber-500 rounded-md px-2 py-1 ">Me</a>
...
const HomePage = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (showSecondSection) return; // ⏹ Disable while About is open
...
>
        ...
        <h2 className="text-4xl md:text-3xl mb-6">Your Trusted Home Companion</h2>
        <p className="text-lg md:text-xl text-gray-300 max-w-4xl mx-auto">
          Finding skilled workers 👷‍♂, reliable dealers 🧱, and top-quality materials 🪵 for your dream home 🏠 shouldn’t be a hassle.  
Kutumb brings everything you need under one roof 🏡 — connecting you with trusted professionals 🤝 and premium products ✨,  
so you can build and renovate with confidence and ease.
        </p>
      </div>
